...
<head>
    ...
    <title>Add Project | Rahmad Cloud</title>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="text-center mb-4">
                <h2 class="fw-bold text-white mb-1">Create New Project</h2>
                <p class="text-white-50">Isi detail project lu di bawah, pastiin gambarnya cakep.</p>
            </div>
                ...
                <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Contoh: Sistem Monitoring IoT" required>
                        </div>

                        <div class="col-12">
                            <label class="form-label"><i class="bi bi-justify-left text-info"></i> Full Description</label>
                            <textarea name="description" rows="5" class="form-control" placeholder="Ceritain sedikit tentang project ini, pake bahasa apa, buat apa..." required></textarea>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-link-45deg text-info"></i> Project URL (Optional)</label>
                            <input type="url" name="link" class="form-control" placeholder="https://github.com/...">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label"><i class="bi bi-stack text-info"></i> Tech Stack</label>
                            <input type="text" name="tech_stack" class="form-control" placeholder="Contoh: Laravel, Python, C++">
                        </div>

                        <div class="col-12">
                            <label class="form-label"><i class="bi bi-image text-info"></i> Thumbnail Image</label>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    <button type="submit" class="btn-neon">
                                        <i class="bi bi-cloud-arrow-up me-2"></i> Publish Project
                                    </button>
                                </div>
                                <div class="col-md-4">
